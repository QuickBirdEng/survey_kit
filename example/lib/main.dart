...
void main() {
  Content.registerFromJson('audio', ska.AudioContent.fromJson);
  Content.registerFromJson('video', VideoContent.fromJson);
  Content.registerFromJson('lottie', LottieContent.fromJson);
  runApp(const MyApp());
}
